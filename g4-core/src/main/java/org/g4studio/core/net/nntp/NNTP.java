...
public class NNTP extends SocketClient {
     ...
     * @param args    The arguments to the NNTP command. If this parameter is set to
     ...
     * @throws NNTPConnectionClosedException If the NNTP server prematurely closes the connection as a
     ...
     * @throws IOException                   If an I/O error occurs while either sending the command or
     ...
     * <p/>
     *
     * @param command The NNTPCommand constant corresponding to the NNTP command to
     *                send.
     * @param args    The arguments to the NNTP command. If this parameter is set to
     *                null, then the command is sent with no argument.
     * @return The integer value of the NNTP reply code returned by the server
     ...
     * <p/>
     *
     * @param messageId The message identifier of the requested article, including the
     ...
     * <p/>
     *
     * @param articleNumber The number of the article to request from the currently
     *                      selected newsgroup.
     * @return The reply code received from the server.
     * @throws NNTPConnectionClosedException If the NNTP server prematurely closes the connection as a
     *                                       result of the client being idle or some other reason
     ...
     * <p/>
     *
     * @param messageId The article identifier, including the encapsulating &lt and
     *                  &gt characters.
     * @return The reply code received from the server.
     * @throws NNTPConnectionClosedException If the NNTP server prematurely closes the connection as a
     *                                       result of the client being idle or some other reason
     ...
     * <p/>
     *
     * @param date          The date after which to check for new groups. Date format is
     *                      YYMMDD
     * @param time          The time after which to check for new groups. Time format is
     *                      HHMMSS using a 24-hour clock.
     * @param GMT           True if the time is in GMT, false if local server time.
     * @param distributions Comma-separated distribution list to check for new groups. Set
     ...
     * @param date          The date after which to check for new news. Date format is
     *                      YYMMDD
     * @param time          The time after which to check for new news. Time format is
     *                      HHMMSS using a 24-hour clock.
     * @param GMT           True if the time is in GMT, false if local server time.
     * @param distributions Comma-separated distribution list to check for new news. Set
     *                      to null if no distributions.
     * @return The reply code received from the server.
     * @throws NNTPConnectionClosedException If the NNTP server prematurely closes the connection as a
     *                                       result of the client being idle or some other reason
     ...
     * <p/>
     *
     * @param selectedArticles a String representation of the range of article headers
     ...
     * <p/>
     *
     * @param header           a String naming a header line (e.g., "subject"). See RFC-1036
