...
public class FTPFileList {
     ...
     * invoked at create()
     *
     * @param parser   a <code>FTPFileEntryParser</code> value that knows how to
     ...
     *
     * @param stream   The input stream created by reading the socket on which the
     *                 output of the LIST command was returned
     * @param parser   the default <code>FTPFileEntryParser</code> to be used by this
