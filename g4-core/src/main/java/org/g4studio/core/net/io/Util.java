...
public final class Util {
     ...
     * @param streamSize The number of bytes in the stream being copied. Should be set
     ...
     * @param flush      Whether to flush the output stream after every write. This is
     *                   necessary for interactive sessions that rely on buffered
     *                   streams. If you don't flush, the data will stay in the stream
     *                   buffer.
     * @throws CopyStreamException If an error occurs while reading from the source or
     ...
     * @param streamSize The number of characters in the stream being copied. Should be
