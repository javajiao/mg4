...
public class SimpleNNTPHeader {
     ...
     * <p/>
     *
     * @param from    The value of the <code>From:</code> header field. This should
     *                be the article poster's email address.
     * @param subject The value of the <code>Subject:</code> header field. This
     ...
     * <p/>
     *
     * @param newsgroup The newsgroup to add to the article's newsgroup distribution
     *                  list.
     *                  *
     */
