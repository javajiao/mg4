...
public class FTPClient extends FTP implements Configurable {
     ...
     * <p/>
     *
     * @param timeout The default timeout in milliseconds that is used when opening
     ...
     * <p/>
     *
     * @param fileType The <code> _FILE_TYPE </code> constant indcating the type of
     *                 file.
     * @return True if successfully completed, false if not.
     * @throws FTPConnectionClosedException If the FTP server prematurely closes the connection as a
     *                                      result of the client being idle or some other reason
     ...
     * @param fileType         The <code> _FILE_TYPE </code> constant indcating the type of
     *                         file.
     * @param formatOrByteSize The format of the file (one of the <code>_FORMAT</code>
     ...
     * <p/>
     *
     * @param filename The name on which to base the filename of the file that is to
     *                 be stored.
     * @return True if successfully completed, false if not.
     * @throws FTPConnectionClosedException If the FTP server prematurely closes the connection as a
     *                                      result of the client being idle or some other reason
     ...
     *                                      exception may be caught either as an IOException or
     *                                      independently as itself.
     * @throws CopyStreamException          If an I/O error occurs while actually transferring the
     ...
     * <p/>
     *
     * @param parserKey This is a "handle" which the parser factory used must be able
     ...
     *                  <p/>
     * @param pathname  The file or directory to list. Since the server may or may not
     ...
     * @throws IOException                   If an I/O error occurs while either sending a command to
     *                                       the server or receiving a reply from the server.
     * @throws ParserInitializationException Thrown if the parserKey parameter cannot be resolved by
     ...
     * @throws IOException                   If an I/O error occurs while either sending a command to
     *                                       the server or receiving a reply from the server.
     * @throws ParserInitializationException Thrown if the autodetect mechanism cannot resolve the type
     ...
     * <p/>
     *
     * @param parser   The <code> FTPFileListParser </code> that should be used to
     ...
     * large lists.
     *
     * @param parser The <code> FTPFileEntryParser </code> that should be used to
     ...
     *
     * @param config {@link FTPClientConfig FTPClientConfig} object used to provide
