...
public class FTPFileIterator {
     ...
     *
     * @param entry A string containing one entry, as determined by the parser's
     *              getNextEntry() method.
     ...
     *
     * @param quantityRequested the maximum number of entries we want to get. A 0 passed here
