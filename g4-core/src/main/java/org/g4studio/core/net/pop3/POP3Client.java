...
public class POP3Client extends POP3 {
     ...
     * @throws IOException If a network I/O error occurs in the process of logging
     *                     in.
     *                     *
     */
     ...
     * @param secret    The shared secret which produces the MD5 digest when combined
     *                  with the timestamp.
     * @return True if the login attempt was successful, false if not.
     * @throws IOException              If a network I/O error occurs in the process of logging
     *                                  in.
     * @throws NoSuchAlgorithmException If the MD5 encryption algorithm cannot be instantiated by
     ...
     * @throws IOException If a network I/O error occurs in the process of sending
     *                     the NOOP command.
     *                     *
     */
