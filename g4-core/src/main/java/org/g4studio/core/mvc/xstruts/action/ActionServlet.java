...
public class ActionServlet extends HttpServlet {
     ...
     * module,
     * @throws ServletException If we cannot instantiate a RequestProcessor instance a
     ...
     * @param paths  Comma-separated list of context-relative resource path(s) for
     ...
     * @param configType The type of configuration object of configName.
     * @param configName The name of the config that's missing the required value.
     * @throws ServletException to communicate the error.
     */
     ...
     * @throws UnavailableException if an instance of the form bean config class cannot be
     *                              created.
     ...
     * config's ancestor and its own overridden value.
     * @throws UnavailableException if an instance of the forward config class cannot be created.
     * @throws ServletException     on class creation error
     */
     ...
     * config's ancestor and its own overridden value.
     * @throws ServletException if an instance of the exception config class cannot be
     *                          created.
     */
     ...
     * config's ancestor and its own overridden value.
     * @throws ServletException if an instance of the action config class cannot be created.
     */
