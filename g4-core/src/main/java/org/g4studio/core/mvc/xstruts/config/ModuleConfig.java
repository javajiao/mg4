...
public interface ModuleConfig {
     ...
     * </p>
     *
     * @param actionFormBeanClass default class name to be used when creating action form bean
     *                            instances.
     */
     ...
     * </p>
     *
     * @param actionForwardClass default class name to be used when creating action forward
     *                           instances.
     */
