...
public class DynaActionFormClass implements DynaClass, Serializable {
     ...
     * </p>
     *
     * @param config The FormBeanConfig instance describing the properties of the
     *               bean to be created
     * @throws IllegalArgumentException if the bean implementation class specified in the
