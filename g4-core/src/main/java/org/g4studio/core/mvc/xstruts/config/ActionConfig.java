...
public class ActionConfig extends BaseConfig {
     ...
     * <code>name</code>.
     *
     * @param attribute the request-scope or session-scope attribute name under which
     ...
     * </p>
     *
     * @param inherit the path of the ActionConfig that this object should inherit
     *                properties from.
     */
     ...
     *
     * @param forward context-relative path of the web application resource that
     ...
     * <code>include</code>, or <code>type</code> must be specified.
     *
     * @param include context-relative path of the web application resource that
     *                will process this request.
     */
    ...
    /**
     * @param scope scope ("request" or "session") within which our form bean is
     *              accessed, if any.
     */
     ...
     * </p>
     *
     * @param command name of a <code>commons-chain</code> command which should be
     *                executed as part of the processing of this action.
     * @since Struts 1.3.0
     */
     ...
     * </p>
     *
     * @param config The object that this instance will be inheriting its values
     *               from.
