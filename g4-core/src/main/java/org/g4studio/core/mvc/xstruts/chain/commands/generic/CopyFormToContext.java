...
public class CopyFormToContext extends ActionCommandBase {
     ...
     * @throws InstantiationException   If ActionContext is not subsclass of ActionContextBase
     */
     ...
     * @throws IllegalAccessException   On failed instantiation
     * @throws IllegalStateException    If ActionContext is not a subclass of ActionBase
     */
