...
public class RequestUtils {
     ...
     * @throws InstantiationException if this class has no zero-arguments constructor
     */
     ...
     * @param request The HTTP request whose parameters are to be used to populate
     *                bean properties
     ...
     *
     * @param bean    The JavaBean whose properties are to be set
     * @param prefix  The prefix (if any) to be prepend to bean property names when
     *                looking for matching parameters
     * @param suffix  The suffix (if any) to be appended to bean property names when
     *                looking for matching parameters
     * @param request The HTTP request whose parameters are to be used to populate
     *                bean properties
     * @throws ServletException if an exception is thrown while setting property values
     ...
     * </p>
     *
     * @param request The HTTP request for which the multipart handler should be
     *                found.
     * @return the multipart handler to use, or null if none is found.
     * @throws ServletException if any exception is thrown while attempting to locate the
     *                          multipart handler.
     */
     ...
     * </p>
     *
     * @param request          The (wrapped) HTTP request whose parameters are to be added to
     *                         the map.
