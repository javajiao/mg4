...
public interface SqlMapClientOperations {
     ...
     * @param requiredRowsAffected the number of rows that the update is required to affect
     * @throws org.springframework.dao.DataAccessException in case of errors
     */
     ...
     * @param statementName        the name of the mapped statement
     * @param parameterObject      the parameter object
     * @param requiredRowsAffected the number of rows that the delete is required to affect
     * @throws org.springframework.dao.DataAccessException in case of errors
     */
