...
public interface SqlMapExecutor {
     ...
     * @param id              The name of the statement to execute.
     * @param parameterObject The parameter object (e.g. JavaBean, Map, XML etc.).
     * @param resultObject    The result object instance that should be populated with
     *                        result data.
     ...
     * @throws java.sql.SQLException If the batch could not be executed or if any of the
     *                               statements fails.
     */
