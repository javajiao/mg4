...
public interface SqlMapTransactionManager {
     ...
     *
     * @throws java.sql.SQLException If an error occurs while starting the transaction, or the
     ...
     *
     * @throws SQLException If an error occurs while committing the transaction, or the
